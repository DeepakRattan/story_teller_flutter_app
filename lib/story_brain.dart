...
// The class contains the completer story data along with the functions which operates on data
class StoryBrain {
  //Any field starting with underscore is considered as a primary key
  int _storyNumber = 0;
